            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Closed Job Ticket List</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"> <a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item"> <a href="JobTicketList.html">Job Ticket List</a></li>
                            <li class="breadcrumb-item active">Closed Job List</li>
                        </ol>
                        <div class=" m-0">
                            <div class="card mb-4">
