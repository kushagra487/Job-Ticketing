                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><small class="status-active">Active</small></td>
                                        <td class="action-icons text-center">
                                           <a href="#" class="text-primary"><i class="fas fa-eye action-icon"></i></a> 
                                           <a href="#" class="text-danger mx-2"><i class="fas fa-edit action-icon"></i></a>
                                            <a href="#" class="text-warning"><i class="fas fa-trash-alt action-icon"></i></a>
                                        </td>
                                    </tr><tr>
                                        <td>Jane Doe</td>
